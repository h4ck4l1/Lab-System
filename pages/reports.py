...
templates_dropdown = dcc.Dropdown(
    options = [
        ...
        {"label":"SMALL SUGAR with Urine Fasting","value":json.dumps(["Random Sugar","Fasting Sugar","Urine Sugar(Fasting)"])},
        {"label":"SMALL SUGAR with Urine Random","value":json.dumps(["Random Sugar","Fasting Sugar","Urine Sugar(Random)"])},
