...
input_style = dict(color="red",width="150px",height="25px",position="relative",left="360px",bottom="20px",fontSize=20)
...
def direct_and_indirect_bilirubin_canvas(c:canvas.Canvas,values:list,page_size:str,h:int,entity_height=18):
    ...
    indirect_value = round(total_value - direct_value,2)
    if page_size == "SMALL/A5":
        x = 0
    else:
        x = 1
